#!/usr/bin/env python3
"""Recipe for training a digit classification system. The proposed task classifies
10 digits using AudioMNIST (FSDD).
...
class DigitClassBrain(sb.Brain):
...
if __name__ == "__main__":
    ...
    if not hparams["skip_prep"]:
        sb.utils.distributed.run_on_main(
            ...
            kwargs={
                ...
                "do_random_split": hparams["do_random_split"]
            },
        )
    ...
    digit_class_brain.fit(
        epoch_counter=digit_class_brain.hparams.epoch_counter,
